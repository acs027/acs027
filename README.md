...
[![View in App Store](https://img.shields.io/badge/View%20on%20App%20Store-0D96F6?logo=app-store&logoColor=white)](https://apps.apple.com/us/app/e6b-flight-pro/id6743019639)
...
`Swift` `SwiftUI` `MVVM` `Aviation` `Simulation`
...
Contributed an improvement to **ConversationKit**, adding behavior to hide the attachment button when no attachment actions are registered.

[Repository](https://github.com/peterfriese/ConversationKit) · [Pull Request #19](https://github.com/peterfriese/ConversationKit/pull/19)
...
[![Website](https://img.shields.io/website-up-down-green-red/http/shields.io.svg)](https://acs027.github.io/)
